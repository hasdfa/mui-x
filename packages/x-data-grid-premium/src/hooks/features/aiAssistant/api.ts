import { PromptContext, PromptResponse, PromptResolverOptions } from './gridAiAssistantInterfaces';
 ...
 * @param {PromptContext} context The prompt context containing necessary information about the current columns definition.
...
export function gridDefaultPromptResolver(
  ...
  return fetch(url, {
    ...
    headers: {
      ...
      'x-package-name': '@mui/x-data-grid-premium',
      'x-package-version': process.env.MUI_VERSION ?? '<dev>',
